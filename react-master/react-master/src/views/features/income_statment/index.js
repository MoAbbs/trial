...
class CompanyView extends Component {
    ...
    render() {
        const { loading, filter, settings_schedule, settings__items, settings__item_category, product__company_items, product__company_item_values, product__company_item_check, modal, product__notes } = this.state
                ...
                {loading ?
                    ...
                    : <div>
                        <div className="d-flex justify-content-end w-100">
                            <Note model="income" product__notes={product__notes} />
                            <Filter
                                type={filter?.type}
